      ...
      {/* filters */}
        <div className="flex flex-col sm:flex-row gap-4">
            <div className="relative flex-1">
                ...
                <Input className="pl-8" placeholder="Enter Search Term...." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}/>
            </div>
...

            {
                (searchTerm || typeFilter || recurringFilter) && (
                    <Button variant="outline" size="icon" onClick={handleCleanFilters} title="Clear Filters"><X className="h-4 w-5" /></Button>
                )
            }
            </div>
        </div>
